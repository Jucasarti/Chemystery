...
public class SistemaObjetivos : MonoBehaviour
{
    ...
    [SerializeField] private GameObject objetivoAtualBG;
    ...
    public void MostrarObjetivoAtual () {

        backgroundObject.SetActive(true);

        objetivoAtualBG.SetActive(true);

    }

    public void FecharObjetivoAtual () {

        backgroundObject.SetActive(false);

        objetivoAtualBG.SetActive(false);
